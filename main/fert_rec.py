fertilizer_dic = {
        'Nhigh': """The N value of the soil is high and might give rise to weeds.
        <br/> Please consider the following suggestions:

        <br/><br/>1. <i> Manure </i> - adding manure is one of the simplest ways to amend your soil with nitrogen. Be careful as there are various types of manure with varying degrees of nitrogen.

        <br/>2. <i> Coffee grinds </i> - use your morning addiction to feed your gardening habit! Coffee grinds are considered a green compost material which is rich in nitrogen. Once the grounds break down your soil will be fed with nitrogen. It will also provide increased drainage to your soil.
        ...
        <br/>4. Plant 'Green manure' crops like corn, cabbage, and broccoli.
...
encoded = fertilizer_dic.decode('UT-8')