...
def get_coords(user_address):
	...
	geocode_request = requests.get(f"https://maps.googleapis.com/maps/api/geocode/json?address={user_address}&key=xxxxxxxxxxxxxxxxx")
...
def get_weather_soil_data(lat, lng):
	...
	params = {
		...
		"end_date": '2024-06-13',
		"hourly": ["temperature_2m", "soil_temperature_6cm", "relative_humidity_2m", "soil_moisture_3_to_9cm", "relative_humidity_2m"],
		"temperature_unit": "fahrenheit",
		"wind_speed_unit": "mph",
		"precipitation_unit": "inch",
		"daily": ["snowfall_sum", "sunshine_duration"]
	}
	...
	avg_sunshine = daily_dataframe.loc[:, 'sunshine_duration'].mean()
